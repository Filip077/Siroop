...
import com.siroop.filip.siroop.DataBase.ProductsDbHelper;
import com.siroop.filip.siroop.DataBase.ProductsEntry;

import static com.siroop.filip.siroop.DataBase.ProductsEntry.TABLE_NAME;
...
public class ProductsContentProvider extends ContentProvider {
    ...
    public static final int PRODUCTS_WITH_ID = 101;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(ProductsEntry.AUTHORITY, ProductsEntry.PATH_PRODUCTS, PRODUCTS);
        uriMatcher.addURI(ProductsEntry.AUTHORITY, ProductsEntry.PATH_PRODUCTS + "/#", PRODUCTS_WITH_ID);
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        switch (match) {
            case PRODUCTS:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(ProductsEntry.CONTENT_URI, id);
                } else {
